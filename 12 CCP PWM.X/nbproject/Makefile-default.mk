...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/12_CCP_PWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/12_CCP_PWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
